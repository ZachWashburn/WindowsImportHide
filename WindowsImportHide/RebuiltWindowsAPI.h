...
#ifndef _H_REBUILTWINDOWSAPI
#define _H_REBUILTWINDOWSAPI
#include <Windows.h>
namespace RebuiltWindowsAPI {

#ifndef REBUILT_WINDOWS_API_NO_STATIC
#define RBUILTWINAPISTATIC static
#else 
#define RBUILTWINAPISTATIC /**/
#endif
	...
	FARPROC WINAPI GetExportAddress(_In_ HMODULE hModule, _In_ LPCSTR lpProcName, _In_ BOOLEAN MappedAsImage = true);
	...
	/// <param name="MappedAsImage">Is the module mapped or a raw file? (TRUE / FALSE)</param>
	/// <returns>returns the exported procedure address inside the specified module</returns>	
	FARPROC WINAPI GetExportAddressByHash(_In_ HMODULE hModule, _In_ unsigned long ulProcNameHash, _In_ BOOLEAN MappedAsImage = true);
